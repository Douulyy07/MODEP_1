          ...
          <div className="modal-body">
            <div className="row">
              ...
              <div className="col-md-4 text-center mb-4">
                ...
                <h4 className="fw-bold text-dark">{user?.first_name} {user?.last_name}</h4>
              ...
              <div className="col-md-8">
                ...
                <div className="card border-0 bg-light mt-3">
                  <div className="card-header bg-transparent border-0">
                    <h6 className="fw-bold mb-0">Statistiques d'Activité</h6>
                  </div>
                  <div className="card-body">
                    <div className="row text-center">
                      <div className="col-4">
                        <div className="border-end">
                          <h4 className="fw-bold text-primary mb-0">24</h4>
                          <small className="text-muted">Actions aujourd'hui</small>
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="border-end">
                          <h4 className="fw-bold text-success mb-0">156</h4>
                          <small className="text-muted">Cette semaine</small>
                        </div>
                      </div>
                      <div className="col-4">
                        <h4 className="fw-bold text-warning mb-0">1,247</h4>
